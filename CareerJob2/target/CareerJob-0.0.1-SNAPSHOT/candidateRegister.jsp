...
<html>	
	<head></head>
	<body>		
	<spring:form action="candidate_register.html" method="post" commandName="candidateRegister">
	<table>
		<tr>
			<td>Username:</td>
	...
	<div align="left">
		...
		<form action="candidate_register.html">
			<table>
				<tr>
				...
				<tr>
					<td><input type="email" name="candidate_email"/></td>
